    ...
    return (
        <div className="border-b-2 border-red-200 border-dashed navbar bg-base-200">
            ...
            <div className="navbar-end">
                    ...
                    <div className="dropdown dropdown-end">
                        ...
                        >
                            <div className="w-10 rounded-full">
                                <div className="flex items-center justify-center w-full h-full uppercase badge badge-primary badge-lg">
                                    {name[0]}
                                </div>
                            </div>
                        </div>
                ...
                {!token && (
                    <NavLink
                        className="px-7 btn btn-square btn-primary btn-circle avatar"
                        to={"/login"}
                    >
                        Login
                    </NavLink>
